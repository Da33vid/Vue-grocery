      ...
      <div class="container">
        <div class="logo">
          <a href="/">
            <img
              ...
              class="img-fluid logo-img logo-img--full"
              alt="logo"
            />
            <img
              src="./images/logos/icon.svg"
              class="img-fluid logo-img logo-img--mobile"
              alt="logo"
            />
          </a>
        </div>
        <form class="search">
          <input
            class="form-control"
            type="search"
            placeholder="Search for a product or inspiration"
          />
        ...
        <div class="user-options">
          <div class="user-options__item">
            <a href="" aria-label="Cart" class="nav-link"
              ><i class="fas fa-cart-shopping fa-xl"></i
            ></a>
          </div>
          <div class="user-options__item">
            <a href="" aria-label="User" class="nav-link"
    ...
    <div id="carouselFeatured" class="carousel carousel-dark slide carousel-featured" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="3000">
          <img src="images/featured/featured_clean.png" class="d-block" alt="...">
        ...
        <div class="carousel-item" data-bs-interval="3000">
          <img src="images/featured/featured_iphone.png" class="d-block" alt="...">
          <div class="carousel-caption d-md-block">
            <h5>New iPhone</h5>
        ...
        <div class="carousel-item" data-bs-interval="3000">
          <img src="images/featured/featured_laptop.png" class="d-block" alt="...">
          <div class="carousel-caption d-md-block">
        ...
        <div class="product-card__bottom">
          <div class="product-card__description">
            ...
            <div class="product-card__description">
              ...
              <button @click="goToProduct(product.id)">View Product</button>
            ...
            <section class="products-grid">
              ...
              <article class="product-card">
                ...
                ">
                  <div class="product-card__top">
                    <div class="product-card__image">
                      <img src="./images/products/smartphones/5.jpg" alt="iphone 9">
                      <div class="product-card__discount">
                        <span>18%</span>
                      </div>
                    </div>
            ...
            <section class="products-grid">
              <article class="product-card">
                ...
                ">
                  <div class="product-card__top">
                    <div class="product-card__image">
                      <img src="./images/products/skincare/1.jpg" alt="iphone 9">
                      <div class="product-card__discount">
                        <span>13%</span>
                      </div>
                    </div>
              ...
              <article class="product-card">
                ...
                ">
                  <div class="product-card__top">
                    <div class="product-card__image">
                      <img src="./images/products/skincare/2.jpg" alt="iphone 9">
                      <div class="product-card__discount">
                        <span>4%</span>
                      </div>
                    </div>
              ...
              <article class="product-card">
                ...
                ">
                  <div class="product-card__top">
                    <div class="product-card__image">
                      <img src="./images/products/skincare/3.jpg" alt="iphone 9">
                      <div class="product-card__discount">
                        <span>13%</span>
                      </div>
                    </div>
              ...
              <article class="product-card">
                ...
                ">
                  <div class="product-card__top">
                    <div class="product-card__image">
                      <img src="./images/products/skincare/5.jpg" alt="iphone 9">
                      <div class="product-card__discount">
                        <span>17%</span>
                      </div>
                    </div>
